...
class Ui_MainWindow(object):
    ...
    def __init__(self):
        self.任意名称=MySignals()
        self.任意名称.text_print.connect(self.printToGUI)
        #在程序启动时弹出免责声明窗口
        self.dialog()

    def dialog(self):
        self.box = QMessageBox(QMessageBox.Question, '说明', '本软件完全免费开源')
        # 显示该问答框
        self.box.show()

    #定义信号函数
    def printToGUI(self,信息):
        self.textEdit.append(str(信息))
